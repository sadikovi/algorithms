/*
 * My attempts were building giant matrix of all points and setting true/false for encountered
 * point (Wrong answer), computing overlaps between rectangles and checking that total area is the
 * same (TLE). Solution below runs 0(n) time and passes all tests, taken from Leetcode:
